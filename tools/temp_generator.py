...
def write_pmd_control(title, jobtype):
    ...
    what is the qm method? (enter one of the following options)
        ...
        e2n2        train search adaptive md    use trained excited-equivariant neural network for qm calculations
        ...
        e2n2 xtb                          md    use neural network for qm calculations
...
def write_pmd_e2n2(jobtype):
    search = jobtype == 'search'
    nn, num_eg, num_nac, num_soc = write_pmd_ml(m='e2n2')
    eg = ''
    if num_eg > 0:
