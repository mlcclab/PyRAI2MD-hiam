...
from PyRAI2MD.Machine_Learning.NNsMD.utils.activ import leaky_softplus
from PyRAI2MD.Machine_Learning.NNsMD.utils.activ import shifted_softplus
...
class MLP(ks.layers.Layer):
    ...
    Last layer can be modified separately. Hidden layers are all the same.
    """
