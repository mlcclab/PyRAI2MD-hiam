...
class HopProb:
    ...
    def __init__(self, trajectory=None, keywords=None, job_id=None, job_dir=None):
    ...
    def _surfacehop(self):
        ...
        if self.traj.sfhp == 'fssh':
            self.traj.itr = 3  # this will only initialize A, H, D
